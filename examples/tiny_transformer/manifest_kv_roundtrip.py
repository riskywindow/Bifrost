...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Run a daemon-backed tiny-transformer KV manifest roundtrip."
    )
...
def _format_human_summary(summary: dict[str, Any]) -> str:
    return "\n".join(
        [
            ...
            f"required_member_count: {summary['required_member_count']}",
            f"missing_member_count: {summary['missing_member_count']}",
