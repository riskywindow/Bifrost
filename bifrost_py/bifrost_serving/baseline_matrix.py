...
def build_vllm_command(
    ...
    argv.append("--enable-chunked-prefill" if run.enable_chunked_prefill else "--no-enable-chunked-prefill")
    argv.append("--enable-prefix-caching" if run.enable_prefix_caching else "--no-enable-prefix-caching")
    env: dict[str, str] = {
